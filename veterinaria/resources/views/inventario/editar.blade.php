            ...
            <form action="{{ route('actualizar.producto', $producto->id) }}" method="POST" id="formulario-productos">
                ...
                <div id="formulario-crear">
                    ...
                    <div id="cantidadCampos">
                        ...
                        <md-filled-text-field class="input-uniforme" label="Valor fraccionado" value="{{ $producto->precio_fraccionado }}" type="number" name="precio_fraccionado" min="0" max="999999999" id="precio_fraccionado" prefix-text="$" style="display: none;">
                        </md-filled-text-field>
                    </div>
