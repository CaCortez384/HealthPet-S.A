<x-home>
    ...
    <x-menu-user>
        <div class="container mt-5">
            ...
            <h1 class="mb-3">Buscar pedidos</h1>
            <p class="text-muted">Aquí podras ver el estado de tus pedidos.</p>
            <!-- Filtro de búsqueda -->
            <div id="contenedor_buscar">
                <h6>Buscar pedidos</h6>
                <div id="menu-busqueda">
                    <form action="{{ route('buscar.pedido') }}" method="GET">
                        <div class="row mb-4">
                ...
                @if ($filtros['Numero_pedido'])
                    <div class="d-flex justify-content-between align-items-center mt-3 filtros-activos">
                        ...
                        <a href="{{ route('buscar.pedido', array_filter(request()->except(['numero_pedido']))) }}"
    ...
    @guest
    <div class="container mt-5" style="box-shadow: 5px 5px 20px black; border-radius:20px; padding:20px; margin: 10px; margin:auto; margin-bottom: 20px;">
        <!-- Título y descripción -->
        <h1 class="mb-3">Buscar pedidos</h1>
        <p class="text-muted">Aquí podras ver el estado de tus pedidos.</p>
        <!-- Filtro de búsqueda -->
